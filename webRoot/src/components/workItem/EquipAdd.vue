  ...
  <div>
    ...
    <div class="main_block block-height1">
      <el-col :xs="12" :sm="12" :md="8" :lg="8" :xl="8">
        <div class="grid-content main_row"></div>
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_con">
            <el-select size="small" v-model="termType" placeholder="请选择">
              <el-option v-for="item in termType_options" :key="item.value" :label="item.label" :value="item.value">
              </el-option>
            </el-select>
          </div>
        </div>
      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_con">
            <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="cmt">
            </el-input>
          </div>
        </div>
      </el-col>
        ...
        <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
          ...
          <div class="add_form_item">
            ...
            <div class="add_form_item_con">
              ...
              <el-autocomplete size="small" v-model="queryString" :fetch-suggestions="querySearchAsync" placeholder="请输入内容" @select="handleSelect"></el-autocomplete>
            </div>
          </div>
        </el-col>
    ...
    <div class="main_block block-height2">
        ...
        <div class="add_form_item">
          ...
          <div class="add_form_item_con">
            <el-select size="small" v-model="drivType" placeholder="请选择">
              <el-option v-for="item in drivType_options" :key="item.value" :label="item.label" :value="item.value">
              </el-option>
            </el-select>
          </div>
        </div>
      ...
      <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
        <div class="grid-content main_row">
          <el-button type="primary" size="small" @click="drivParamAdd">新增</el-button>
        </div>
      </el-col>
      ...
      <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
        <div class="grid-content main_row">
          <el-button type="primary" size="small" @click="equipAdd">保存</el-button>
        </div>
      </el-col>
    </div>
  </div>
